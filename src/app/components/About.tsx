...
const aboutText =
  "My name is George Alexander Rhodes, but I go by Alex with family and friends. I was born in Jersey but have lived the majority of my life in the Isle of Man. The IoM is famous for the TT motorbike race, which I highly recommend watching some PoV videos of! The average speed is around 135 mph! But I will always reccomend Jersey first. We have actual beaches and whilst winter is wet, IoM is like a permanent Jersey Winter. \n\n Whilst I was here in Jersey till the age of ten, I went to St George's Preparatory School. Then after moving to the Isle of Man, I went to the secondary school King Williams College and did my GCSEs and the International Baccalaureate instead of A Levels. I took English, Maths, Physics, Geography, German, and Economics with a score of 34 points. \n\nI have always had an interest in Far East Asian culture and have been lucky enough to go to Japan several times. The first time I was working in a guest house there in exchange for free bedding, second time was a home stay, and then my year abroad during my Business and Japanese course at Newcastle University, which was unfortunately impacted because of COVID. \n\nI have always had an interest in programming, logical thinking, and how to maximise efficiency. This is likely due to my passion for gaming and technology. After finishing my degree, I started self studying coding whilst working for the COVID Department of the Jersey Government, which landed me my first position in under five months. I want to further refine my skills in web app development, but also look more into data analysis, data science, and how large data sets can inform business decisions based on trends, analysis, and forming predictive models. For this reason I am currently revisiting Python and learning to use the packages such as matplotlib, pandas, numpy, etc, as well as Microsoft Power BI to create interactive dashboards and reports with the resulting data.";
